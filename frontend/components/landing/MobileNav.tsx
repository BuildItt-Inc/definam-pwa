    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-center gap-8 p-6">
        <a
          href="#how-it-works"
          onClick={() => setOpen(false)}
          className="text-lg font-semibold text-ink hover:text-jade transition-colors"
        >
          How it works
        </a>
        <Link
        ...
        <div className="w-full max-w-xs">
          <Link
            href="/pay/individual"
            onClick={() => setOpen(false)}
            className="flex items-center justify-center gap-2 w-full bg-jade text-white text-[15px] font-semibold px-6 py-3 rounded-xl hover:bg-jade-dark transition-colors"
          >
            Get started
