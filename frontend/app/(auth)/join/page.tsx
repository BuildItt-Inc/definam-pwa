...
export default function JoinPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-0 flex flex-col justify-between">
      <div>
        {/* ── App bar ── */}
        <header className="flex items-center justify-between px-4 h-[56px] border-b border-border-2 bg-bg-0 max-w-xl mx-auto w-full">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[15px] font-bold text-ink tracking-tight flex items-center gap-2">
              <LandingBrandMark size={20} />
        ...
        <main className="px-5 pt-6 pb-12 md:max-w-md md:mx-auto md:pt-8">
          ...
          <ol className="space-y-3">
            {([
              'Your school provided a unique code for your account',
              'Enter your code to access your personalized learning dashboard',
              'Your active device will automatically stay logged into Recall',
            ] as const).map((text, i) => (
      ...
      <footer className="py-4 text-center text-[12px] text-ink/40">
        &copy; Recall 2026
      </footer>
    </div>
  );
